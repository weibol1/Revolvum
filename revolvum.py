...
class Big_disc(pygame.sprite.Sprite):
    ...
    def draw(self):
        ...
        screen.blit(rotated_image, rotated_rect.topleft)
        screen.blit(disc_eye_left_img, (self.x + 50, self.y + 40))
        screen.blit(disc_eye_right_img, (self.x + 150, self.y + 40))
...
littledisc1 = Little_disc(465, 250)  # bottom left disc
littledisc2 = Little_disc(750, 100)  # top right disc
littledisc3 = Little_disc(750, 250)  # bottom right disc
littledisc4 = Little_disc(465, 100)  # top left disc
big_disc_1 = Big_disc(535, -400)
